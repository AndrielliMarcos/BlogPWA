...
namespace Blog.Controllers
{
    public class ControleDeAcessoController : Controller
    {
        ...
        [HttpGet]
        //este metodo é a view do login de fato
        ...
        [HttpPost]
        //metodo de processamento do formulário do login
        ...
        [HttpGet]
        //metodo da view que mostra o formulário do registro
        ...
        [HttpPost]
        //metodo que processa o formulário
